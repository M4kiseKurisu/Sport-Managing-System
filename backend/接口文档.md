...
> 说明：统计用户参加的团体，按照团体标签进行统计。
>
> 保证：用户实体存在。

请求 URL：`http://127.0.0.1:8000/api/user/group/statistic`
...
请求 URL：`http://127.0.0.1:8000/api/user/activity/arrangement`
...
请求 URL：`http://127.0.0.1:8000/api/activity/recommend`
    ...
    "list": [
        {
            "nid": 49554124,
            "text": "贴吧第二美男子申请添加好友",
            "time": "2023-12-12 12:55:23"
        },
        {
            "nid": 25001956,
            "text": "您的团体申请 (大运村) 已被接受",
            "time": "2023-12-11 23:49:05"
        },
        {
            "nid": 88226477,
            "text": "您的团体申请 (大运村) 已被拒绝",
            "time": "2023-12-11 22:17:04"
        }
    ]
}
```
